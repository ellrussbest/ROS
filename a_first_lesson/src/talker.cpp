...
int main(int argc, char** argv) {
    ...
    // Rate is a class that is used to define frequency for a loop. Here we send a message each two seconds
    ros::Rate loop_rate(0.5);

    int count = 0;
    while(ros::ok()){ // Keep spnning loop until user presses Ctr+c
        // create a new String ROS message
        // Mesage definition in this link http://docs.ros.org/api/std_msgs/html/msg/String.html
        std_msgs::String msg;
