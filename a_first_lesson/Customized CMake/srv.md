...
2) Create your own Service message with the following structure. You can put as many variables as you need, of any type supported by ROS: [ROS Message Types](http://wiki.ros.org/msg). Create a srv folder inside your package , as you did with the topics msg folder. Then, inside this srv folder, create a file called MyCustomServiceMessage.srv. You can create with the IDE or the WebShell, as you wish.
...
-   [find_package()](https://s3.eu-west-1.amazonaws.com/notebooks.ws/basic_ROS/unit3_basicROS_Part2_v2.html?AWSAccessKeyId=AKIAJLU2ZOTUFJRMDOAA&Signature=Tx6r7iUu6nTIWCRnIkpVVBn%2B2Bc%3D&Expires=1682206859#find_package)

-   [add_service_files()](https://s3.eu-west-1.amazonaws.com/notebooks.ws/basic_ROS/unit3_basicROS_Part2_v2.html?AWSAccessKeyId=AKIAJLU2ZOTUFJRMDOAA&Signature=Tx6r7iUu6nTIWCRnIkpVVBn%2B2Bc%3D&Expires=1682206859#add_service_files)

-   [generate_messages()](https://s3.eu-west-1.amazonaws.com/notebooks.ws/basic_ROS/unit3_basicROS_Part2_v2.html?AWSAccessKeyId=AKIAJLU2ZOTUFJRMDOAA&Signature=Tx6r7iUu6nTIWCRnIkpVVBn%2B2Bc%3D&Expires=1682206859#generate_messages)

-   [catkin_package()](https://s3.eu-west-1.amazonaws.com/notebooks.ws/basic_ROS/unit3_basicROS_Part2_v2.html?AWSAccessKeyId=AKIAJLU2ZOTUFJRMDOAA&Signature=Tx6r7iUu6nTIWCRnIkpVVBn%2B2Bc%3D&Expires=1682206859#catkin_package)
